 ...
 */
package com.yb.ilibray.utils.io;

import android.os.Build;

import com.yb.ilibray.utils.io.stream.ByteArrayOutputStream;
import com.yb.ilibray.utils.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.yb.ilibray.utils.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
     ...
     * before using {@link com.yb.ilibray.utils.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.yb.ilibray.utils.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
    ...
    public static byte[] toByteArray(Reader input, Charset encoding) throws IOException {
        com.yb.ilibray.utils.io.stream.ByteArrayOutputStream output = new com.yb.ilibray.utils.io.stream.ByteArrayOutputStream();
