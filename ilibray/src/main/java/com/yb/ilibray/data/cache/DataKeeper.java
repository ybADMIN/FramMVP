 ...
 */
package com.yb.ilibray.data.cache;

import android.content.Context;
import android.content.SharedPreferences;

import com.yb.ilibray.utils.data.cipher.Cipher;
...
public class DataKeeper {
    ...
    public static final String DEFULTFILE  = "ilibray.pre";
    ...
    public static void clearPreference(Context context, String fileName) {
        SharedPreferences p =context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
