package com.yb.ilibray.data.download.down;

import android.support.annotation.Nullable;
import android.text.TextUtils;

import com.yb.ilibray.data.download.down.entity.ChuckRelevance;
import com.yb.ilibray.data.download.down.entity.DownloadEntity;
import com.yb.ilibray.data.download.down.exception.DownloadException;
import com.yb.ilibray.data.download.down.sql.DownloadRepository;
